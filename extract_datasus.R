################ Extract data from DataSUS ################

#Code that searches and generates a database of hospital admissions in the
#Brazilian National Health System for respiratory problems.
#It is applied only for the region of Greater Vitória, ES, Brazil
#but can be easily changed and replicated for hospitalization for any
#disease (based on the ICD) or any city in the country.
